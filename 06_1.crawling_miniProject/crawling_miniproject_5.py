# 크롤링 미니 프로젝트 - 포티투닷
# 포티투닷 잡코리아 ID : 44874367 (사이트 구조 다름)
...
COMPANY_ID = "44874367"
MY_JOBS = ['MLOps엔지니어', 'AI/ML연구원', 'AI/ML엔지니어', 'AI서비스개발자', '데이터사이언티스트', '데이터엔지니어', 'QA', 'R&D·연구원']
BASE_URL = f"https://www.jobkorea.co.kr/Recruit/Co_Read/Recruit/C/{COMPANY_ID}?GI_Part_Code={{code}}&Search_Order=1&ChkDispType=0&Part_Btn_Stat=1"
...
def get_job_codes(driver):
    ...
    wait.until(EC.presence_of_all_elements_located((By.CSS_SELECTOR, "button.btnCtgr")))
    human_delay(1.0, 2.0)

    return [
        match.group()
        for btn in driver.find_elements(By.CSS_SELECTOR, "button.btnCtgr")
